...
], PaymentsController.prototype, "getCommissionRules", null);
__decorate([
    (0, common_1.Get)('bands/:bandId/earnings'),
    ...
    __metadata("design:returntype", void 0)
], PaymentsController.prototype, "getBandEarnings", null);
__decorate([
    (0, common_1.Post)('bands/:bandId/payout'),
    (0, common_1.UseGuards)((0, passport_1.AuthGuard)('jwt'), roles_guard_1.RolesGuard),
    (0, roles_decorator_1.Roles)(client_1.UserRole.BAND, client_1.UserRole.ADMIN),
    __param(0, (0, common_1.Param)('bandId')),
    __param(1, (0, current_user_decorator_1.CurrentUser)()),
