...
const IMG = {
  ...
  crowd:
    'https://images.unsplash.com/photo-1459749411175-04bf5292ceea?w=600&h=340&fit=crop',
  stage:
    ...
    data: [
      {
        ...
        accessLevel: AccessLevel.SUBSCRIPTION,
        durationMin: 95,
      ...
      },
      {
        ...
        type: ContentType.LIVE_RECORDING,
        accessLevel: AccessLevel.SUBSCRIPTION,
        durationMin: 78,
    ...
    data: [
      {
        ...
        priceCents: 2500,
        status: LiveShowStatus.SCHEDULED,
